...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_register_script( 'bcj-home-js', get_stylesheet_directory_uri() . '/library/js/home_scripts.min.js', array( 'jquery'), '', true );
		...
		*/
		...
		if( is_home() || is_front_page()) wp_enqueue_script( 'bcj-home-js' );
