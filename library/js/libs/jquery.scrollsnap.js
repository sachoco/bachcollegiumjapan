        ...
        return this.each(function() {
            ...
            if (scrollingEl.nodeType == 1) {
                ...
                var handler = function(e) {
                    ...
                    var matchingEl = null, matchingDy = winHeight*settings.proximity + 1;
                ...
                var handler = function(e) {
                    ...
                    $(scrollingEl).find(settings.snaps).each(function() {
                        ...
                        var snappingEl = this,
                            ...
                            dy = ($(snappingEl).offset()[leftOrTop.toLowerCase()] + settings.offset) - win[tempOffset];

                        if (dy>0&&dy < matchingDy) {
                            matchingEl = snappingEl;
                            matchingDy = dy;
                        }
                    });
